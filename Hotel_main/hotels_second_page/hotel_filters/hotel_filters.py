...
class FiltersLocators(BaseMethods):
    ...
    def check_the_check_box_rating_0_2(self):
    ...
    def check_the_check_box_rating_3_5(self):
    ...
    def assert_h3(self):
        self.is_element_present(FiltersLocators.DISTANCE_TO_THE_CENTER_P)
        self.sleep(2)

    def assert_h6(self):
        self.is_element_present(FiltersLocators.DISTANCE_TO_THE_CENTER_H6)
        self.sleep(2)

    def assert_hidden_upper_arrow(self):
    ...
    def assert_amenities_in_the_room_container(self):
        self.is_element_present(FiltersLocators.AMENITIES_IN_THE_ROOM_CONTAINER)
        self.sleep(2)

    def assert_amenities_in_the_room_check_box_presence(self):
    ...
    def assert_amenities_in_the_room_check_box_clickable(self):
        self.assert_element_to_be_clickable(FiltersLocators.AMENITIES_IN_THE_ROOM_CHECK_BOX_1)
        self.sleep(2)

    def assert_upper_hidden_room_link(self):
    ...
    def assert_hidden_room_link(self):
