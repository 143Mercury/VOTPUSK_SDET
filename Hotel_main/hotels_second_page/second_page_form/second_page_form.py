...
# Проверка работоспособности функционала внутренней формы поиска отелей
    ...
    def assert_len_hotel_list(self):
        self.is_dropdown_present(SecondFormLocators.FORM_LEN)
        self.sleep(2)

    def assert_check_in(self):
        self.page_loaded(SecondFormLocators.CHECK_IN)
    ...
    def assert_dropdown_quantity(self):
