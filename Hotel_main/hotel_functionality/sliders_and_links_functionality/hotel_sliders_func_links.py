...
class SlidersHotelLinksLocator(BaseMethods):
    ...
    def check_all_same_hotel_locators_1_4(self):  #
    ...
    def check_all_same_hotel_locators_5_8(self):
    ...
    def check_the_hotels_leaders_offer_1_2(self):
    ...
    def check_the_hotels_leaders_offer_5_8(self):
    ...
    def assert_navigation_arrow_next_clickable(self):
    ...
    def assert_navigation_arrow_prev_clickable(self):
