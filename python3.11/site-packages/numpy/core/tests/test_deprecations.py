"""
test related to deprecation warnings. Also a convenient place
...
class TestFromStringAndFileInvalidData(_DeprecationTestCase):
    # 2019-06-08, 1.17.0
    # test should be moved to real tests when deprecation is done.
...
class FlatteningConcatenateUnsafeCast(_DeprecationTestCase):
    ...
    def test_not_deprecated(self):
        ...
        with assert_raises(TypeError):
            # test should notice if the deprecation warning is given first...
...
class TestFutureWarningArrayLikeNotIterable(_DeprecationTestCase):
    ...
    def test_deprecated(self, protocol):
        ...
        *not* define the sequence protocol.
        ...
        NOTE: test for the versions including __len__ and __getitem__ exist
