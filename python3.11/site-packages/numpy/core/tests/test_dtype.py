...
class TestStructuredDtypeSparseFields:
    """test subarray fields which contain sparse dtypes so that
...
class TestPromotion:
    ...
    def test_permutations_do_not_influence_result(self, dtypes, expected):
        # test that most permutations do not influence the result.  In the
...
class TestUserDType:
    ...
    def test_custom_structured_dtype_errors(self):
        ...
        with pytest.raises(ValueError):
            # test what happens if fields are unset during creation
        ...
        with pytest.raises(RuntimeError):
            # test that a dtype must have its type field set up to np.dtype
