...
class TestBinomial:
    def test_n_zero(self):
        # test the corner case of n == 0 for the binomial distribution.
...
class TestRandomDist:
    ...
    def test_integers_max_int(self):
        # test whether integers with closed=True can generate the
    ...
    def test_scalar_exception_propagation(self):
        # test that exceptions are correctly propagated in distributions
