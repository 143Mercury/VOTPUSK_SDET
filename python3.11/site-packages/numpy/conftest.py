...
def pytest_configure(config):
    config.addinivalue_line("markers",
        "valgrind_error: test that are known to error under valgrind.")
    config.addinivalue_line("markers",
        "leaks_references: test that are known to leak references.")
    config.addinivalue_line("markers",
        "slow: test that are very slow.")
    config.addinivalue_line("markers",
        "slow_pypy: test that are very slow on pypy.")
