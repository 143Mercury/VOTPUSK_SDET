...
# ==============================================================================
"""test for tf.keras models using tf.distribute.Strategy."""
...
class TestDistributionStrategyWithMultipleAddLossAndMetricCalls(
    ...
    """test complex models with multiple add loss and metric calls."""
...
class TestModelCapturesStrategy(tf.test.TestCase, parameterized.TestCase):
    """test that model creation captures the strategy."""
