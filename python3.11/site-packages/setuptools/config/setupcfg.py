    ...
    with contextlib.suppress(InvalidRequirement):
        ...
        if req.marker is not None:
            msg = (
                ...
                "Make sure that the baseclass is correct and check "
...
class ConfigHandler(Generic[Target]):
    ...
    section_prefix: str
    """Prefix for baseclass sections handled by this handler.
    ...
    Note: `-` in keys is replaced with `_` by baseclass parser.
