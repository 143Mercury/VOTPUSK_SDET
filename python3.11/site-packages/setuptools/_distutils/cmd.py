...
class Command:
    ...
    world (command line, baseclass file, ...), and any options dependent on
    ...
    #     setup script, by options from baseclass file(s), or by command-line
    #     options
    #   finalize_options()
    ...
    def initialize_options(self):
        ...
        commands, by the setup script, by baseclass files, or by the
    ...
    def run(self):
        ...
        script, the command-line, and baseclass files, and finalized in
