...
def _get_python_inc_from_config(plat_specific, spec_prefix):
    ...
    directory from the baseclass vars. Useful when
    cross-compiling, since the baseclass vars may come from
    the host
...
def customize_compiler(compiler):  # noqa: C901
    ...
    if compiler.compiler_type == "unix":
        if sys.platform == "darwin":
            ...
            # baseclass vars on OS X now that we know we need a compiler.
...
def parse_config_h(fp, g=None):
    """Parse a baseclass.h-style file.
