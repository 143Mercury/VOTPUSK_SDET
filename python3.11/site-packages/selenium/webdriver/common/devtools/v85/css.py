...
class RuleMatch:
    ...
    #: Matching selector indices in the rule's selectorList css_selectors (0-based).
...
class SelectorList:
    ...
    def to_json(self):
        json = dict()
        json['css_selectors'] = [i.to_json() for i in self.selectors]
        json['text'] = self.text
        return json
    ...
    def from_json(cls, json):
        return cls(
            selectors=[Value.from_json(i) for i in json['css_selectors']],
            text=str(json['text']),
        )
